...
export const ScoreStrip: React.FC<Props> = ({ matches }) => {
    ...
    return (
        <div className="w-full bg-white/90 backdrop-blur-2xl border-b border-zinc-100 sticky top-[80px] z-[40] h-12 flex items-center overflow-hidden group/strip">
            {/* HUD Background Grid Pattern */}
            <div className="absolute inset-0 opacity-[0.03] pointer-events-none bg-[radial-gradient(#000_1px,transparent_1px)] [background-size:20px_20px]" />

            <div className="flex items-center gap-4 px-6 border-r border-zinc-100 h-full bg-zinc-50/50 relative z-10">
                                    ...
                                    <div className="flex items-center gap-4 relative z-10">
                                        ...
                                        <div className="flex items-center gap-4">
                                            <div className="flex items-center gap-2">
                                                <span className="text-[12px] font-black uppercase tracking-tight text-zinc-900 group-hover/item:text-indigo-600 transition-colors">
                                            ...
                                            <span className="text-zinc-200 text-[10px] font-black group-hover/item:scale-150 transition-transform tracking-widest mx-1 opacity-50">VS</span>
                                            <div className="flex items-center gap-2">
                                                <LiveScorePulse
                                                    value={awayScore}
                                                    className="text-[12px]"
                                                ...
                                                />
                                                <span className="text-[12px] font-black uppercase tracking-tight text-zinc-400 group-hover/item:text-zinc-900 transition-colors">
                                                    {awayTeam.shortName || awayTeam.name.substring(0, 3)}
                                                </span>
                                            </div>
                                        </div>

                                        <div className="flex items-center gap-2 opacity-0 group-hover/item:opacity-100 transition-all translate-x-4 group-hover/item:translate-x-0 ml-2">
            ...
            <div className="px-6 border-l border-zinc-100 h-full flex items-center gap-3 bg-zinc-50/50 relative z-10 group/status cursor-help">
                <div className="relative">
                    <Activity className="w-3 h-3 text-zinc-300 group-hover/status:text-indigo-500 transition-colors" />
                    <motion.div
                ...
                <span className="text-[8px] font-black text-zinc-400 uppercase tracking-[0.3em] group-hover/status:text-zinc-900 transition-colors">Uplink: Primary</span>
            </div>
        </div>
    );
};
